...
<template>
  <v-card flat class="home">
    ...
    <v-card v-for="year in reports" :key="year.year">
      ...
      <!-- Report Cards -->
      <v-card v-for="item in year.data" :key="item.title">
        <v-card-title class="pb-0 mb-0">
          <div>
            ...
            <p class="pa-0 ma-0 grey--text">{{ item.coAuthor }}</p>
          </div>
        </v-card-title>
      ...
      reports: [
        {
          ...
          data: [{
            ...
            abstract: `I'm a thing. But, like most politicians, he promised more than he could deliver. 
